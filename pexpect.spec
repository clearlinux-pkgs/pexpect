...
Version  : 4.3.0
Release  : 32
URL      : http://pypi.debian.net/pexpect/pexpect-4.3.0.tar.gz
Source0  : http://pypi.debian.net/pexpect/pexpect-4.3.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1510261528
